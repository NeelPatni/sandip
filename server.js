...
app.use(cors({
  origin: ["https://sandipnanavati.com", "https://www.sandipnanavati.com", "http://127.0.0.1:5500", "http://localhost:5500"],
  methods: ["GET", "POST"],
...
const transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: process.env.SMTP_USER || "neel@taniyaweb.site",
    pass: process.env.SMTP_PASS || "Client@2025n",
  },
});
